...
public class MainV2 {
    public static void main(String[] args) {
        ...
        PhoneBookV2 phonebook = new PhoneBookV2();
        do {
            System.out.println();
            ...
            switch (mainMenuChoice)
            {
                ...
                case 3:
                    do{
                        ...
                        editRemoveMenuChoice = menuInput.get();
                        ...
                        switch (editRemoveMenuChoice)
                        {
                            case 1:
                                ...
                                do{
                                    ...
                                    System.out.println();
                                    System.out.print("Выберите пункт меню: ");
                                    removeMenuChoice = menuInput.get();

                                    switch (removeMenuChoice)
                                    {
                                        case 1:phonebook.viewRecords2(); break;
                                        case 2:
                                            int removeInd = -1;
                                            System.out.print("Введите индекс: ");

                                            removeInd = menuInput.get();
                ...
                case 4:
                    do{
                        ...
                        searchMenuChoice = menuInput.get();
                        ...
                        phonebook.searchRecords2(searchMenuChoice, searchStr);
                        }
